...
def RP_plot_xlsx(xlsx_save_dir, xlsx_name, sheet_name, if_AUC=True, xmin = 0., xmax = 1., cls_key = 'PatientID'):
...
def RP_plot_json(json_save_dir, json_name, sheet_name, if_AUC=True, xmin = 0., xmax = 1., cls_key = 'PatientID'):
