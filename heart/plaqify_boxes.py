...
# If the reliability of a plaque is too low, it would be deleted. The reliability would be evaluated from a customised
# metric, see is_reliable_plaque for details.
...
def is_reliable_plaque(plaque):
    '''
    After plaque matching, delete plaques that have low accuracies.
    Hyperparameter, MIN_ACCURACY, decrease this value then less plaques would be deleted. Expect higher recall and fp
    :param plaque:
    :return: if this plaque should be output as result.
    '''
