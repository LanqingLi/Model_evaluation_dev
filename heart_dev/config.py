...
config.CLASSES_LABELS_XLS_FILE_NAME = 'heart_dev/classname_labelname_mapping.xls'
config.CLASSES, config.SEG_CLASSES, config.CLASS_DICT, config.CONF_THRESH, config.CLASS_WEIGHTS = get_label_classes_from_xls(config.CLASSES_LABELS_XLS_FILE_NAME)
