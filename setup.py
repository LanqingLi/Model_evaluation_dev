...
setup(
    ...
    description="Python package for matching model-detected objects (nodules), as part of post-process", # Required
    ...
    url="https://github.com/LanqingLi/ObjMatch", # Optional
